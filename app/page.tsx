      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-8">
        <div className="text-center space-y-6">
          ...
          <div className="space-y-4">
            <p className="text-lg">Ready to visualize your music?</p>
            <button
              onClick={() => signOut()}
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8">
      <div className="text-center space-y-8">
        ...
        <button
          ...
          className="px-8 py-4 bg-green-500 hover:bg-green-600 text-white rounded-full text-xl font-medium transition-colors flex items-center gap-3 mx-auto cursor-pointer"
        >
